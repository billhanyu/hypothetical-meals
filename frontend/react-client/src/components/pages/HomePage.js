...
import ProductionRunNonReport from '../homepage/productionrun_nonreport/ProductionRunNonReport';
...
class HomePage extends Component {
  ...
  renderComponent() {
    ...
    else if (funcName == 'productionrun_nonreport') {
      return <ProductionRunNonReport />;
    }
  }
